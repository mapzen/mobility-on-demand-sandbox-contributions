...
define("mod-sandbox/submit/data/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "bs-button", [], ["type", "primary", "icon", "glyphicon glyphicon-chevron-left", "onClick", ["subexpr", "action", ["changeRoute", "submit.intro"], [], ["loc", [null, [8, 78], [8, 115]]]]], 0, null, ["loc", [null, [8, 2], [10, 16]]]], ["block", "bs-button", [], ["type", "primary", "icon", "glyphicon glyphicon-chevron-right", "onClick", ["subexpr", "action", ["changeRoute", "submit.license"], [], ["loc", [null, [14, 79], [14, 118]]]]], 1, null, ["loc", [null, [14, 2], [16, 16]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
if (!runningTests) {
  require("mod-sandbox/app")["default"].create({"name":"mod-sandbox","version":"0.0.0+61ab3a34"});
}
